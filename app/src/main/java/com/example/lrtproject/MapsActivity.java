...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback, GoogleMap.OnMapLongClickListener {
    ...
    private void addGeofence(LatLng latLng, float geofence_radius) {
        Geofence geofence = getGeofence(GEOFENCE_ID, latLng, geofence_radius, Geofence.GEOFENCE_TRANSITION_ENTER | Geofence.GEOFENCE_TRANSITION_DWELL | Geofence.GEOFENCE_TRANSITION_EXIT);
        System.out.println("KELUAR APA: " + GEOFENCE_ID + " || " + latLng+ "||" + geofence_radius);
